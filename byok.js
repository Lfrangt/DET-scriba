...
直接、精炼、像中国老师改作文。中文为主。`;
  ...
  async function reviewEssay(payload) {
    ...
    const fullPrompt = payload.mode === 'interactive'
      ? buildInteractivePrompt(payload.prompt, payload.answer, payload.prompt2, payload.answer2)
      : buildSamplePrompt(payload.prompt, payload.answer);
